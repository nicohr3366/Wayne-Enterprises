"""
Django settings for wayne_enterprise project.
...
SECRET_KEY = 'django-insecure-ru%@q&kb%6@l(i*1jug&^p^6pk#t*m&nc14rzgq6&x74+q=g8q'
...
ROOT_URLCONF = 'wayne_enterprise.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],   # ← carpeta templates/ compartida
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'wayne_enterprise.wsgi.application'
